...
def apPhot(im, xg, yg, fwhm, apR, inR, outR):
    '''Performs aperture photometry for the object near xg, yg. Assuming xg, yg are
    accurate centroids, the flux within apR is found and a robust estimate of the
    backgnd for that aperture is found.'''
    ...
    bkAve, bkSDev = robomad(im2[bkList], thresh)
